 ...
 */
package club.dawdler.boot.maven;
...
public class BootStrapFinder {
	public static final String DAWDLER_SERVER_BOOT_APPLICATION_NAME = "club.dawdler.boot.server.annotation.DawdlerBootApplication";
	public static final String DAWDLER_WEB_BOOT_APPLICATION_NAME = "club.dawdler.boot.web.annotation.DawdlerBootApplication";
