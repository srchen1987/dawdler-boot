 ...
 * the Map used to store the dynamic attribute names and values passed to the custom action invocation. This information
...
class JasperTagInfo extends TagInfo {
    ...
    JasperTagInfo(String tagName, String tagClassName, String bodyContent, String infoString, TagLibraryInfo taglib,
            TagExtraInfo tagExtraInfo, TagAttributeInfo[] attributeInfo, String displayName, String smallIcon,
            String largeIcon, TagVariableInfo[] tvi, String mapName) {
