...
public abstract class Rule {
     ...
     *
     * @return The namespace URI for which this rule is relevant or <code>null</code> if none.
     */
    ...
    /**
     * This method is called when the beginning of a matching XML element is encountered. The default implementation is
     * a NO-OP.
     *
    ...
    /**
     * This method is called when the end of a matching XML element is encountered. The default implementation is a
     * NO-OP.
     *
     * @param namespace the namespace URI of the matching element, or an empty string if the parser is not namespace
     *                      aware or the element has no namespace
