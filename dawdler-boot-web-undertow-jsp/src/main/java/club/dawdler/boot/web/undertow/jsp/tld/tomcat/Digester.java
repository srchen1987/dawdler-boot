...
import club.dawdler.boot.web.undertow.jsp.tld.tomcat.IntrospectionUtils.PropertySource;
...
public class Digester extends DefaultHandler2 {
            ...
            while (classNamesTokenizer.hasMoreTokens()) {
                ...
                for (ClassLoader cl : cls) {
                    try {
                        ...
                        ExceptionUtil.handleThrowable(t);
                        logger.error("", t);
                    }
                }
            }
            ...
            for (String name : names) {
                ...
                if (value != null) {
                    try {
						...
						logger.warn("System property [{0}] failed to update and remains [{1}]", name, value, e);
                    }
                }
            }
        }
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        if ((rules != null) && (!rules.isEmpty())) {
            ...
            if (rulesValidation) {
				logger.warn("No rules found matching [{0}]", match);
            }
        }
    ...
    public void endPrefixMapping(String prefix) throws SAXException {
        ...
        try {
            ...
            throw createSAXException("Empty stack");
        }
    ...
    public void startDocument() throws SAXException {
        ...
        if (locator instanceof Locator2) {
            if (root instanceof DocumentProperties.Charset) {
                ...
                if (enc != null) {
                        ((DocumentProperties.Charset) root).setCharset(Charset.defaultCharset());
                }
            }
        }
    ...
    public SAXException createSAXException(String message, Exception e) {
        ...
        if (locator != null) {
            String error = "Error at line [" + locator.getLineNumber() + "] column [" + locator.getColumnNumber() + "]: " + message;
            if (e != null) {
