...
public class DigesterFactory {
    ...
    static {
        ...
        // W3C
        add(publicIds, XmlIdentifiers.XSD_10_PUBLIC, locationForLocal("XMLSchema.dtd"));
        add(publicIds, XmlIdentifiers.DATATYPES_PUBLIC, locationForLocal("datatypes.dtd"));
        add(systemIds, XmlIdentifiers.XML_2001_XSD, locationForLocal("xml.xsd"));
    ...
    private static String locationFor(String name) {
        java.net.URL location = CLASS_SERVLET_CONTEXT.getResource("resources/" + name);
    ...
    private static String locationForLocal(String name) {
        return DigesterFactory.class.getResource(name).toExternalForm();
    }
     ...
     */
    public static Digester newDigester(boolean xmlValidation, boolean xmlNamespaceAware, TldRuleSet rule,
