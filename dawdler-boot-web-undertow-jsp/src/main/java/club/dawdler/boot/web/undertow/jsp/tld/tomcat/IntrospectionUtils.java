...
public final class IntrospectionUtils {
    ...
    public static boolean setProperty(Object o, String name, String value, boolean invokeSetProperty,
        ...
        try {
            ...
            ExceptionUtil.handleThrowable(e.getCause());
            logger.warn("", e);
        }
        return false;
    }
    ...
    private static String replaceProperties(String value, Hashtable<Object,Object> staticProp,
        ...
        if (iterationCount >= 20) {
			logger.warn("Property failed to be resolved and remains [{0}]", value);
            return value;
        }
    ...
    public static Object callMethod1(Object target, String methodN, Object param1, String typeParam1, ClassLoader cl)
        ...
        if (target == null || methodN == null || param1 == null) {
            throw new IllegalArgumentException("Method name, parameter and object target arguments must not be null");
        }
        ...
        if (m == null) {
            throw new NoSuchMethodException("Cannot find method \"" + methodN + "\" in object " + target + " of class " + target.getClass().getName());
        }
        try {
            return m.invoke(target, param1);
        } catch (InvocationTargetException ie) {
            ExceptionUtil.handleThrowable(ie.getCause());
            throw ie;
        }
    }
    ...
    public static Object convert(String object, Class<?> paramType) {
        ...
        if (result == null) {
            throw new IllegalArgumentException("Error converting [" + object + "] to type [" + paramType.getName() + "]");
        }
        return result;
    }
